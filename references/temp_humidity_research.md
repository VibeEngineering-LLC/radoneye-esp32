...
**Опкод/поле для чтения температуры и влажности на RadonEye Plus2 / RD200P /
Plus3 публично не задокументирован ни в одном из 7 живых open-source репо.**
Прибор сам датчики имеет и показывает их в FTLAB Connect, но как именно
приложение их получает по BLE — закрыто. Не угадывать. Не пробовать
случайные опкоды (это уже привело к DFU mode в сессии 2026-06-07).
